...
const SecureChat = ({signalProtocolManagerUser}) =>{
        ...
        <Container className=''>
            {
              ...
              <div className='Chat-List'>
              {
                    ...
                    {
                     chats.map((chat)=>(
                         <NavLink to={`/secure-chat/${chat._id}`}>
  ...
  <Alerts alert={`You don't have conversations Yet !!`} alertType="info"/>
                          ...
                          <Route path=":convid" element={     <SecureChatBox chat={currentChat} currentUser ={authUser._id} signalProtocolManagerUser={signalProtocolManagerUser} />} />
                    </Routes>
